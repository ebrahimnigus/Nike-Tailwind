  ...
  return (
    <section id="home" className="w-full flex xl:flex-row flex:col justify:center min-h-screen gap-10 max-container">
      <div className="relative xl:2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <p className="font-montserrat text-slate-gray text-lg leading-8 mt:6 mt:6 mb:-20 gap-16">Discover stylish Nike arrivals, quality comfort,and innovation for your active life.</p>
